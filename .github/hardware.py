...
hardware_fields = {
    ...
    "frequency_custom": FieldType.BOOL,
    "frequency_minimum": FieldType.INT,
    "frequency_maximum": FieldType.INT,
    "frequency_count": FieldType.INT,
    "frequency_center": FieldType.INT,
